...
<html lang="fr">
	...
	<body>
			...
			<nav class="navbar navbar-inverse">
				<div class="container-fluid">
					<div class="navbar-header" >
						<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#menu1" aria-expanded="false" id="machin">
		...
		<h3>Bienvenue sur  WikYnov le tout nouveau Wiki créé et réservé exclusivement aux étudiants Ynov. Il vous sera donc possible de partager et de poster des fichiers entre étudiants et plein d'autres trucs.</h3>
		</div>
	 	<footer>
				<div id="footer">
					<div class="container">
